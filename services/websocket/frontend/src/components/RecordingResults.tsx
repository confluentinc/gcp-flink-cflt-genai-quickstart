...
export const RecordingResults = ({ messages, isProcessing = false }: RecordingResultsProps) => {
  ...
  return (
    <ScrollArea className="h-[400px] w-full rounded-md border bg-white">
      <div className="p-4 space-y-4">
        {isProcessing ? (
          <div className="w-full p-8 flex flex-col items-center justify-center space-y-4 bg-white ">
            <img
              src={doctor}
              alt="Doctor"
              ...
              >
                ...
                >
                  <CardContent className="p-4">
                    ...
                    {message.audioUrl && (
                      ...
                      >
                        <source
                          ...
                          type={message.type === 'user' ? 'audio/webm' : 'audio/wav'}
                        />
                    ...
                    <p
                      className={`text-xs ${
                        message.type === 'ai' ? 'text-white/80' : 'text-muted-foreground'
                      } mt-2`}
                    >
